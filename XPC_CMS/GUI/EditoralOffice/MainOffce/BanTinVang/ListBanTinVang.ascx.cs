...
namespace DFISYS.GUI.EditoralOffice.MainOffce.BanTinVang
{
    public partial class ListBanTinVang : System.Web.UI.UserControl
    {
        DatMuaBanTinVang btVang = new DatMuaBanTinVang();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                BindPage();
                List<DatMuaBanTinVang> tbl = btVang.SelectAllSearch(pageSize, Convert.ToInt32(ddlPageUp.SelectedValue), txtKeyword.Text);
        ...
        private void BindPage()
        {
            ...
            int totalPage = (btVang.SelectAllCount(txtKeyword.Text) - 1) / pageSize + 1;
