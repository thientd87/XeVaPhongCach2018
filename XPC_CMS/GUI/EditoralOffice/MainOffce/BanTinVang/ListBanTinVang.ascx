<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListBanTinVang.ascx.cs" Inherits="DFISYS.GUI.EditoralOffice.MainOffce.BanTinVang.ListBanTinVang" %>
<asp:HiddenField ID="hdArgs" runat="server" />
<asp:HiddenField ID="hdNewsID" runat="server" />
<h1 style="text-align: center">
    Quản lý đặt mua bản tin vàng</h1>
                    ...
                    <asp:TemplateField HeaderText="Nội dung Giao lưu">
                        <ItemTemplate>
                            <div style="display: none">
                                <input type="text" id="hID" value="<%#Eval("UserID") %>" /></div>
                            <a href="/office/giao_luu_edite.aspx?courseId=<%#Eval("UserID")%>">
                                <%#HttpUtility.HtmlEncode(Eval("Name").ToString()).Replace("\n", "<br/>")%></a>
                            <br />
                        </ItemTemplate>
