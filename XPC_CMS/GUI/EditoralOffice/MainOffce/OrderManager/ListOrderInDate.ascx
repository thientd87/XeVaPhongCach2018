<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListOrderInDate.ascx.cs" Inherits="MobileShop.GUI.Back_End.Order.ListOrderInDate" %>
<div class="container-fluid">
        ...
        <div class="span12">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-edit"></i>Danh sách các đơn hàng đang chờ thanh toán</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="dataTables_wrapper form-inline" role="grid">
                        <asp:GridView  ID="gvListProducts" runat="server" CssClass="table table-striped table-hover table-bordered dataTable" RowStyle-CssClass="odd" AlternatingRowStyle-CssClass="even" 
                            AllowPaging="True" AutoGenerateColumns="False" DataSourceID="objListOrder" PageSize="20"  Width="100%" EmptyDataText="Chưa có đơn hàng đang chờ thanh toán" OnRowCommand="gvListProducts_RowCommand" >
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="M&#227; h&#243;a đơn">
                                 <ItemTemplate>                                                      
                                        <a href='/office/orderdetail.aspx?type=indate&oid=<%#Eval("O_ID")%>' style="color:#333;">
    ...
    <!-- END PAGE CONTENT -->
                ...
                <asp:ObjectDataSource ID="objListOrder" runat="server" SelectMethod="GetOrderInRequiredDate" DeleteMethod="DeleteOrderByID" TypeName="BO.OrderHelper">
                                <DeleteParameters>
