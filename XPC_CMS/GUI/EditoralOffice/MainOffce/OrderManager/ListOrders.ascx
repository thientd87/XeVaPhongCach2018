<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListOrders.ascx.cs" Inherits="MobileShop.GUI.Back_End.Order.ListOrders" %>
        ...
        <div class="span12">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-edit"></i>Danh sách đơn hàng vừa gửi</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="dataTables_wrapper form-inline" role="grid">
                        <asp:GridView CssClass="table table-striped table-hover table-bordered dataTable" RowStyle-CssClass="odd" AlternatingRowStyle-CssClass="even" 
                            ID="gvListProducts" runat="server" AllowPaging="True" 
                            AutoGenerateColumns="False" DataSourceID="objListOrder" PageSize="20" Width="100%" EmptyDataText="Chưa có đơn hàng nào được gửi"
                             OnRowCommand="gvListProducts_RowCommand" >
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <input id="chkAll" onclick="GoselectAll(this.checked);" type="checkbox" />
                                    </HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="M&#227; h&#243;a đơn">
                                    ...
                                    <ItemTemplate>                                                      
                                         <a href='/office/orderdetail.aspx?type=list&oid=<%#Eval("O_ID")%>' style="color:#333;">
                                ...
                                <asp:TemplateField HeaderText="Duyệt">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="lbtDuyet" CommandName="duyet" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"O_ID")%>'
                                           runat="server">
                    ...
                    <div class="table-toolbar">
                        <div class="btn-group">
                             <asp:LinkButton ID="lbtnDuyet" OnClientClick="return getCheckedIDs();" runat="server" CssClass="btn green" OnClick="lbtnDuyet_Click"><i class="icon-ok"></i> Duyệt đơn hàng</asp:LinkButton>
...
<asp:ObjectDataSource ID="objListOrder" runat="server" SelectMethod="GetNewOrder" DeleteMethod="DeleteOrderByID" TypeName="BO.OrderHelper" UpdateMethod="UpdateIsRemoveeOrderByID">
                                            <DeleteParameters>
