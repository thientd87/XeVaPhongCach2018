<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrderDetailIsPaid.ascx.cs" Inherits="MobileShop.GUI.Back_End.Order.OrderDetailIsPaid" %>
										...
										<div class="tab-pane active form-horizontal">
										   <div class="control-group">
                                                ...
                                                <div class="control-group">
													...
													<div class="controls">
													  <asp:Label runat="server" ID="rdpRequiredDate"></asp:Label>
                                                        ...
                                                        <div class="portlet-body">
                                                            <div class="dataTables_wrapper form-inline" role="grid">
                                                                <asp:GridView runat="server" ID="gvCart" Width="100%"  AutoGenerateColumns="false" CssClass="table table-striped table-hover table-bordered dataTable" RowStyle-CssClass="odd" AlternatingRowStyle-CssClass="even" 
                                                                    ShowFooter="true" EmptyDataRowStyle-ForeColor="red" OnDataBound="gvCart_DataBound">
                                                                    <Columns>
                                                                        <asp:TemplateField>
                                                                            <HeaderTemplate>
