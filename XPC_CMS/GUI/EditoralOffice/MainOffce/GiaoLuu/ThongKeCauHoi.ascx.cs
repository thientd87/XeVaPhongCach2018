...
{
    public partial class ThongKeCauHoi : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                BindPage();
                List<Question> tbl = quest.SelectAllSearch(pageSize, Convert.ToInt32(ddlPageUp.SelectedValue), txtKeyword.Text, idCourse);
        ...
        private void BindPage()
        {
            ...
            int totalPage = (quest.SelectAllCount(txtKeyword.Text, idCourse) - 1) / pageSize + 1;
