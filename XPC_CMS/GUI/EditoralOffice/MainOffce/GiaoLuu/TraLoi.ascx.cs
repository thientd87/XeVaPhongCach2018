...
{
    public partial class TraLoi : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                BindPage(idCourse, user);
                List<Question> tbl = question.SelectAllSearchByUser(pageSize, Convert.ToInt32(ddlPageUp.SelectedValue), txtKeyword.Text, idCourse, user);
        ...
        private void BindPage(int id, string user)
        {
            ...
            int totalPage = (question.SelectAllCountByUser(txtKeyword.Text, id, user) - 1) / pageSize + 1;
