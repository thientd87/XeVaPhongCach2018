...
namespace DFISYS.Core.DAL {
    /// <summary>
    /// The base class for <see cref="NewsPublishedCollection"/>. Provides methods 
    /// for common database table operations. 
    /// </summary>
    /// <remarks>
    /// Do not change this source code. Update the <see cref="NewsPublishedCollection"/>
    /// class if you need to add or change some functionality.
    /// </remarks>
    public abstract class NewsPublishedCollection_Base {
        // Constants
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsPublishedCollection_Base"/> 
        /// class with the specified <see cref="MainDB"/>.
        /// </summary>
        /// <param name="db">The <see cref="MainDB"/> object.</param>
        public NewsPublishedCollection_Base(MainDB db) {
            _db = db;
        }
        ...
        /// <summary>
        /// Gets an array of all records from the <c>NewsPublished</c> table.
        /// </summary>
        /// <returns>An array of <see cref="NewsPublishedRow"/> objects.</returns>
        public virtual NewsPublishedRow[] GetAll() {
            return MapRecords(CreateGetAllCommand());
        }

        /// <summary>
        /// Gets a <see cref="System.Data.DataTable"/> object that 
        /// includes all records from the <c>NewsPublished</c> table.
        /// </summary>
        ...
        /// to retrieve all records from the <c>NewsPublished</c> table.
        /// </summary>
        ...
        /// <summary>
        /// Gets the first <see cref="NewsPublishedRow"/> objects that 
        /// match the search condition.
        /// </summary>
        /// <param name="whereSql">The SQL search condition. For example: 
        /// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
        /// <returns>An instance of <see cref="NewsPublishedRow"/> or null reference 
        /// (Nothing in Visual Basic) if the object was not found.</returns>
        public NewsPublishedRow GetRow(string whereSql) {
            int totalRecordCount = -1;
            NewsPublishedRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
            return 0 == rows.Length ? null : rows[0];
        }

        /// <summary>
        /// Gets an array of <see cref="NewsPublishedRow"/> objects that 
        ...
        /// <returns>An array of <see cref="NewsPublishedRow"/> objects.</returns>
        public NewsPublishedRow[] GetAsArray(string whereSql, string orderBySql) {
            int totalRecordCount = -1;
        ...
        /// <returns>An array of <see cref="NewsPublishedRow"/> objects.</returns>
        public virtual NewsPublishedRow[] GetAsArray(string whereSql, string orderBySql,
        ...
        public virtual NewsPublishedRow[] GetTopAsArray(int topNum, string whereSql, string orderBySql) {
            int totalRecordCount = -1;
        ...
        public virtual int GetCount(string sqlWhere) {
            string sqlStr = "Select Count(*) From [dbo].[NewsPublished]" + ((sqlWhere == "") ? "" : (" Where " + sqlWhere));
        ...
        /// <summary>
        /// Gets Custom Page of NewsPublishedRow
        /// </summary>
        ...
        /// <returns>An Array of NewsPublishedRow</returns>
        public NewsPublishedRow[] GetPageAsArray(int pageNumber, int pageSize, string whereSql, string orderBySql) {
        ...
        protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql) {
            string sql = "SELECT * FROM [dbo].[NewsPublished]";
            if (null != whereSql && 0 < whereSql.Length)
                sql += " WHERE " + whereSql;
            if (null != orderBySql && 0 < orderBySql.Length)
                sql += " ORDER BY " + orderBySql;
        ...
        protected virtual IDbCommand CreateGetTopCommand(int topNum, string whereSql, string orderBySql) {
            string sql = "SELECT TOP " + topNum.ToString() + " * FROM [dbo].[NewsPublished]";
            if (null != whereSql && 0 < whereSql.Length)
                sql += " WHERE " + whereSql;
            if (null != orderBySql && 0 < orderBySql.Length)
                sql += " ORDER BY " + orderBySql;
        ...
        /// <summary>
        /// Gets <see cref="NewsPublishedRow"/> by the primary key.
        /// </summary>
        /// <param name="news_ID">The <c>News_ID</c> column value.</param>
        /// <returns>An instance of <see cref="NewsPublishedRow"/> or null reference 
        /// (Nothing in Visual Basic) if the object was not found.</returns>
        public virtual NewsPublishedRow GetByPrimaryKey(long news_ID) {
            string whereSql = "[News_ID]=" + _db.CreateSqlParameterName("@News_ID");
            IDbCommand cmd = CreateGetCommand(whereSql, null);
            AddParameter(cmd, "@News_ID", news_ID);
            NewsPublishedRow[] tempArray = MapRecords(cmd);
            return 0 == tempArray.Length ? null : tempArray[0];
        }

        /// <summary>
        /// Adds a new record into the <c>NewsPublished</c> table.
        /// </summary>
        /// <param name="value">The <see cref="NewsPublishedRow"/> object to be inserted.</param>
        public virtual void Insert(NewsPublishedRow value) {
            string sqlStr = "INSERT INTO [dbo].[NewsPublished] (" +
                "[News_ID], " +
                "[Cat_ID], " +
                "[News_Title], " +
                "[News_Subtitle], " +
               ...
               _db.CreateSqlParameterName("@Extension4") + ");SELECT @@IDENTITY";
            IDbCommand cmd = _db.CreateCommand(sqlStr);
        ...
        public virtual bool Update(NewsPublishedRow value) {
            string sqlStr = "UPDATE [dbo].[NewsPublished] SET " +
        ...
        /// <summary>
        /// Deletes the specified object from the <c>NewsPublished</c> table.
        /// </summary>
        /// <param name="value">The <see cref="NewsPublishedRow"/> object to delete.</param>
        /// <returns>true if the record was deleted; otherwise, false.</returns>
        public bool Delete(NewsPublishedRow value) {
            return DeleteByPrimaryKey(value.News_ID);
        }

        /// <summary>
        /// Deletes a record from the <c>NewsPublished</c> table using
        ...
        /// <summary>
        /// Deletes <c>NewsPublished</c> records that match the specified criteria.
        /// </summary>
        ...
        /// to delete <c>NewsPublished</c> records that match the specified criteria.
        /// </summary>
        /// <param name="whereSql">The SQL search condition. 
        /// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
        /// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
        protected virtual IDbCommand CreateDeleteCommand(string whereSql) {
            string sql = "DELETE FROM [dbo].[NewsPublished]";
            if (null != whereSql && 0 < whereSql.Length)
                sql += " WHERE " + whereSql;
            return _db.CreateCommand(sql);
        }
        ...
        /// <summary>
        /// Deletes all records from the <c>NewsPublished</c> table.
        /// </summary>
        /// <returns>The number of deleted records.</returns>
        ...
        /// <returns>An array of <see cref="NewsPublishedRow"/> objects.</returns>
        protected NewsPublishedRow[] MapRecords(IDbCommand command) {
        ...
        /// <returns>An array of <see cref="NewsPublishedRow"/> objects.</returns>
        protected NewsPublishedRow[] MapRecords(IDataReader reader) {
            int totalRecordCount = -1;
            return MapRecords(reader, 0, int.MaxValue, ref totalRecordCount);
        }
        ...
        /// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
        /// <returns>An array of <see cref="NewsPublishedRow"/> objects.</returns>
        protected virtual NewsPublishedRow[] MapRecords(IDataReader reader,
                                        int startIndex, int length, ref int totalRecordCount) {
            if (0 > startIndex)
            ...
            while (reader.Read()) {
                ri++;
                if (ri > 0 && ri <= length) {
                    NewsPublishedRow record = new NewsPublishedRow();
            ...
            return (NewsPublishedRow[])(recordList.ToArray(typeof(NewsPublishedRow)));
        }
        ...
        /// <summary>
        /// Converts <see cref="System.Data.DataRow"/> to <see cref="NewsPublishedRow"/>.
        /// </summary>
        /// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
        /// <returns>A reference to the <see cref="NewsPublishedRow"/> object.</returns>
        protected virtual NewsPublishedRow MapRow(DataRow row) {
            NewsPublishedRow mappedObject = new NewsPublishedRow();
    ...
    } // End of NewsPublishedCollection_Base class
}  // End of namespace
