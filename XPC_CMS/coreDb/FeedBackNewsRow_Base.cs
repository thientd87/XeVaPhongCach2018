...
{
	/// <summary>
	/// The base class for <see cref="FeedBackNewsRow"/> that 
	/// represents a record in the <c>FeedBackNews</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="FeedBackNewsRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FeedBackNewsRow_Base
	{
		...
		private string _news_Relation1 ;
		private int _nhuanbut ;
		private bool _nhuanbutNull = true;

		/// <summary>
		/// Initializes a new instance of the <see cref="FeedBackNewsRow_Base"/> class.
		/// </summary>
		public FeedBackNewsRow_Base()
		{
			// EMPTY
		}

		/// <summary>
		/// Gets or sets the <c>FeedBack_ID</c> column value.
		/// </summary>
		/// <value>The <c>FeedBack_ID</c> column value.</value>
		...
		/// <summary>
		/// Gets or sets the <c>News_Relation1</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>News_Relation1</c> column value.</value>
		public string News_Relation1
		{
			get { return _news_Relation1; }
			set { _news_Relation1 = value; }
		}

		/// <summary>
		/// Gets or sets the <c>Nhuanbut</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>Nhuanbut</c> column value.</value>
		public int Nhuanbut
		{
			get
			{
		...
		/// <summary>
		/// Indicates whether the <see cref="Nhuanbut"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsNhuanbutNull
		{
			get { return _nhuanbutNull; }
			set { _nhuanbutNull = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("  Icon=");
			dynStr.Append(Icon);
			dynStr.Append("  News_Relation1=");
			dynStr.Append(News_Relation1);
			dynStr.Append("  Nhuanbut=");
			dynStr.Append(IsNhuanbutNull ? (object)"<NULL>" : Nhuanbut);
			return dynStr.ToString();
		}
	} // End of FeedBackNewsRow_Base class
} // End of namespace
